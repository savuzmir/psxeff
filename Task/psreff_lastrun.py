...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\lab\\OneDrive - University College London\\Sebastijan\\RewardxEffort\\Experiment2\\Experiment\\psreff3.psyexp',
...
# Setup the Window
win = visual.Window(
    size=[860, 640], fullscr=False, screen=0,
